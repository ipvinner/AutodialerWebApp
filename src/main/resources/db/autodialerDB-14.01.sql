...
-- Started on 2016-01-14 13:30:20
...
1	from-ami	my_context	s-ANSWERED	1	f	30000	var1Value	var2Value	SIP/zadarma/
...
1	admin	$2a$10$kkBdkvfxaqHIz2zAlyfGAeS5LGazEVoEpQ2iZAlETnjP9G5iSHgN2	ROLE_ADMIN
2	manager	$2a$10$kkBdkvfxaqHIz2zAlyfGAeS5LGazEVoEpQ2iZAlETnjP9G5iSHgN2	ROLE_MANAGER
3	user	$2a$10$kkBdkvfxaqHIz2zAlyfGAeS5LGazEVoEpQ2iZAlETnjP9G5iSHgN2	ROLE_USER
\.
...
--
-- TOC entry 1885 (class 2606 OID 147674)
-- Name: fk_list_id; Type: FK CONSTRAINT; Schema: public; Owner: SYSDBA
--

ALTER TABLE ONLY client
    ADD CONSTRAINT fk_list_id FOREIGN KEY (clients_list_id) REFERENCES list(id) ON DELETE CASCADE;


--
-- TOC entry 1887 (class 2606 OID 147684)
-- Name: fk_list_id; Type: FK CONSTRAINT; Schema: public; Owner: SYSDBA
--

ALTER TABLE ONLY task
    ADD CONSTRAINT fk_list_id FOREIGN KEY (client_list_id) REFERENCES list(id) ON DELETE CASCADE;


--
-- TOC entry 1886 (class 2606 OID 147679)
...
-- Completed on 2016-01-14 13:30:22
